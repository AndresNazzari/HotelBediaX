...
/// <summary>
/// Validator for the <see cref="CreateDestinationCommand"/> request.
/// </summary>
public class CreateDestinationCommandValidator : AbstractValidator<CreateDestinationCommand>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="CreateDestinationCommandValidator"/> class
    /// and defines validation rules for creating a destination.
    /// </summary>
